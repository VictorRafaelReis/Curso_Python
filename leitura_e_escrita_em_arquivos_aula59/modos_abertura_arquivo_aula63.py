...
#OBS: Abrindo no modo 'a' -> append, se o arquivo não existir será criado, caso exista, o novo conteúdo será adicionado SEMPRE ao final do arquivo, com o modo 'a', não controlamos
#o cursor.
