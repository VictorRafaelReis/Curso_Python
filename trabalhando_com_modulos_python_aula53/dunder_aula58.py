...
#Em Python, se executarmos um módulo Python diretamente na linha de comando, internamente o Python atribuirá à variável __name__ o valor __main__, indicando que este módulo é o módulo
#de execução principal.


#Exemplos:

    import primeiro_aula58
    import segundo_aula58
"""